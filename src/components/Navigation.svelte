...
<nav
  class="top-0 flex items-center justify-between h-20 px-12 py-4 shadow-md bg-gray-300 dark:bg-gray-900 md:px-24"
>
  <a class="text-3xl font-bold leading-none" href="/">C</a>
  ...
  <div class="relative z-50 navbar-menu">
    ...
    >
      <div class="flex items-center mb-8">
        <a class="mr-auto text-3xl font-bold leading-none" href="/">Colorado Coders</a>
